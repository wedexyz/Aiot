    ...
    faceDetector.setOnFaceAddedCallback(function (addedFaces, detectedFaces) {
        for (var i = 0; i < addedFaces.length; i++) {
            ...
            console.log(addedFaces[i].faceIndex);
           // document.getElementById('nomor').innerHTML =addedFaces[i].faceIndex;
    ...
    faceDetector.setOnFaceUpdatedCallback(function (detectedFaces) {
        ...
        for (var i = 0; i < detectedFaces.length; i++) {
           ...
           setTimeout(function(){ ta() }, 10000); 
            ...
            }else if(document.getElementById('suhuc').innerHTML >37 )
            setTimeout(function(){ tb() }, 10000); 
        }
    });
